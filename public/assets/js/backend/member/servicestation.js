define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'member/servicestation/index' + location.search,
                    add_url: 'member/servicestation/add',
                    edit_url: 'member/servicestation/edit',
                    del_url: 'member/servicestation/del',
                    multi_url: 'member/servicestation/multi',
                    import_url: 'member/servicestation/import',
                    table: 'admin',
                }
            });
                            ...
                            buttons: [
                                {
                                    ...
                                    url: 'member/servicestation/detail',
                                }
                            ],
