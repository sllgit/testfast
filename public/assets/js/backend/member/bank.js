define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'member/bank/index' + location.search,
                    add_url: 'member/bank/add',
                    edit_url: 'member/bank/edit',
                    del_url: 'member/bank/del',
                    multi_url: 'member/bank/multi',
                    import_url: 'member/bank/import',
                    table: 'admin',
                }
            });
