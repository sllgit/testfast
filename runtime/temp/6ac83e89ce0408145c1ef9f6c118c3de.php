...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-bank_names" class="form-control hide" name="bank_name" type="text" value="<?php echo htmlentities($row['bank_name']); ?>">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <?php echo build_radios('row[status]', ['1'=>'正常', '0'=>'异常'],$row['status']); ?>
        </div>
    </div>
