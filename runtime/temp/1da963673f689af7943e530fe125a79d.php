...
<form id="add-form" class="form-horizontal form-ajax" role="form" data-toggle="validator" method="POST" action="">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input type="text" class="form-control hide" id="service_id" name="row[service_id]" value=""/>
            <input type="text" class="form-control" name="row[service_name]" disabled id="service_name" value=""/>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input type="text" class="form-control" id="phone" name="row[phone]" value="" data-rule="required:mobile" />
        </div>
    </div>
    <div class="form-group">
                    ...
                    <div class="modal-body">
                        <div id="addbody">
                            <div class="addbody1">
                                ...
                                <div class="jia xian"></div><span class="spans" sid="0">郸城县</span>
