...
<form id="edit-form" class="form-horizontal" role="form" data-toggle="validator" method="POST" action="">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-area" class="form-control" name="row[area]" type="text" value="<?php echo htmlentities($row['area']); ?>">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-village" class="form-control" name="row[village]" type="text" value="<?php echo htmlentities($row['village']); ?>">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-staff_num" class="form-control" name="row[staff_num]" placeholder="请输入主要股东数量" type="number" value="<?php echo htmlentities($row['staff_num']); ?>">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-loan_term" class="form-control" name="row[loan_term]" type="number" min="0" value="<?php echo htmlentities($row['loan_term']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Uppoor_num'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-uppoor_num" class="form-control" name="row[uppoor_num]" type="number" min="0" value="<?php echo htmlentities($row['uppoor_num']); ?>">
        </div>
    </div>
