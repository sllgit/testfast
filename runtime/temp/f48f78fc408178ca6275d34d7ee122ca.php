...
<form id="edit-form" class="form-horizontal" role="form" data-toggle="validator" method="POST" action="">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <?php echo build_radios('row[is_faucet]', ['否'=>'否', '是'=>'是'],$row['is_faucet']); ?>
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-credit_code" data-rule="required" class="form-control" name="row[credit_code]" type="text" value="<?php echo htmlentities($row['credit_code']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Deputy_username'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-deputy_username" class="form-control" name="row[deputy_username]" type="text" min="0" value="<?php echo htmlentities($row['deputy_username']); ?>">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-staff_num" class="form-control" name="row[staff_num]" placeholder="请输入主要股东数量" type="text" value="<?php echo htmlentities($row['staff_num']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Loan_price'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-loan_price" class="form-control" name="row[loan_price]" type="number" min="0" value="<?php echo htmlentities($row['loan_price']); ?>">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group Res hide">
        ...
        <div class="col-xs-12 col-sm-8 field">
            <?php echo build_radios('row[overduereason]', $overduereason , $row['overduereason'] ); ?>
        </div>
    </div>
    <!--<div class="form-group">-->
        <!--<label class="control-label col-xs-12 col-sm-2"><?php echo __('Loan_term'); ?>:</label>-->
        <!--<div class="col-xs-12 col-sm-8">-->
            <!--<input id="c-loan_term" class="form-control" name="row[loan_term]" type="text" value="<?php echo htmlentities($row['loan_term']); ?>">-->
        <!--</div>-->
    <!--</div>-->
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-uppoor_num" class="form-control" name="row[uppoor_num]" type="text" value="<?php echo htmlentities($row['uppoor_num']); ?>">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <?php echo build_radios('row[loanmodel]', $loanmodel ,$row['loanmodel']); ?>
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8 field">
            <?php echo build_checkboxs('row[uppoor_type][]', $uppoortype ,$row['uppoor_type']); ?>
        </div>
    </div>
