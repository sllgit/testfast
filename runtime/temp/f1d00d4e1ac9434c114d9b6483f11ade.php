            ...
            <div class="tab-pane fade active in" id="one">
                <div class="widget-body no-padding">
                    <div id="toolbar" class="toolbar">
                        ...
                        <!--<?php dump($servicetype);?>-->
                        <a href="javascript:;" data-area='["100%","100%"]' class="btn btn-success btn-add <?php echo $servicetype == true ? '':'hide'; ?>" title="<?php echo __('Add'); ?>" ><i class="fa fa-plus"></i> <?php echo __('Add'); ?></a>
                    ...
                    <table id="table" class="table table-striped table-bordered table-hover table-nowrap"
                           data-operate-edit="<?php echo $auth->check('loan/user/edit'); ?>"
                           data-operate-del="<?php echo $auth->check('loan/user/del'); ?>" 
                           width="100%">
                    </table>
                </div>
            </div>
